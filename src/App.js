    ...
    <div className="App">
            ...
            <div className="row align-items-center">
                <div className="col d-flex justify-content-between">
                    <a href={"/"} className={"d-flex align-items-center"}>
                            <img className={"logo-img mr-3"} src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/285/thermometer_1f321-fe0f.png" alt="Thermomètre"/> ClimateTracker
                    </a>
                    <div>
                        <div className={"header-links-trigger"}>
                            <div className={"d-flex align-items-center"}>
                                <div className={"mr-2"}>Les outils</div>
                            ...
                            <div className="header-links-wrapper">
                                <ul className={"header-links"}>
                                    {tools.map(tool => (
                                        <li>
                                            <a target={"blank"} href={tool.link} className={"header-link d-flex align-items-center"}>
                                                <img className={"mr-2"} src={tool.logo} alt="Logo du projet"/>
                                                {tool.title}
                                            </a>
                                        </li>
                                    ))}
        ...
        <div className="container mt-5 pt-4">
            <div className="row">
                {tools.map(tool => (
                    <div className="col-6">
                        <a className="tool" href={tool.link} target={"_blank"} style={{'backgroundColor': tool.backgroundColor, 'color': tool.color}}>
                            <div className={"text-center mb-3 mt-4"}>
                                <img src={tool.logo} alt="Logo du projet"/>
                            </div>
                            <div>
